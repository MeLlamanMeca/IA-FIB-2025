...
(b1 of Vino-tinto
    ...
    (temporadas primavera verano otoño invierno)
    (festividad true)
    (propiedades_dieteticas bajo-en-sodio kosher nut-free sin-gluten sin-lactosa vegano vegetariano)
    (precio 15.00)
)
...
(b3 of Cerveza
    ...
    (temporadas primavera verano otoño invierno)
    (festividad false)
    (propiedades_dieteticas bajo-en-sodio kosher nut-free sin-lactosa vegano vegetariano)
    (precio 3.00)
)
